...
DATAPATH=${DATAPATH:-${DATA_ROOT}/processed_data/meta/calvin_abcd_norm.pkl}
ACTION_TOKENIZER_PATH=${ACTION_TOKENIZER_PATH:-${PROJECT_ROOT}/pretrain/fast_calvin_norm_a10_s50}
...
EXP_NAME=${EXP_NAME:-UNIVLA_CALVIN_ABCD_VIDEO_BS192_8k}
...
MAX_POSITION_EMBEDDINGS=${MAX_POSITION_EMBEDDINGS:-1700}
